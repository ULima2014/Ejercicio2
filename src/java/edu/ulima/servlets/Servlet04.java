...
import edu.ulima.daos.TbestacionamientoDAO;
...
public class Servlet04 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Tbestacionamiento e = new Tbestacionamiento();
        e.setLote(lote);
        e.setPiso(piso);
        TbestacionamientoDAO dao = new TbestacionamientoDAO();
        dao.persist(e);
        //Tbalumno a = (Tbalumno)ses.getAttribute("actual");
        //TbalumnoDAO dao = new TbalumnoDAO();
        //dao.actualizar(a, e);
